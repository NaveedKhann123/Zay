...
.nav-icons a .cart-badge,
.nav-icons a .user-badge {
  position: absolute;
  top: -4px;
  right: -4px;
...
@media (max-width: 480px) {
  ...
  .contact-info { flex-direction: column; align-items: center; gap: 6px; font-size: 12px; }
